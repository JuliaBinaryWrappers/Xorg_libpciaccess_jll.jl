...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libpciaccess_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a65dc6b1-eb27-53a1-bb3e-dea574b5389e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libpciaccess", artifacts_toml) for e in artifacts["Xorg_libpciaccess"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libpciaccess; unsupported platform $(triplet(platform_key_abi()))")
else
